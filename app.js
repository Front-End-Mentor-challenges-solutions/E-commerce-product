...
const mobBigImg = document.querySelector(".mob-main-img")
...
const imageArr = ["./image-product-1.jpg","./image-product-2.jpg","./image-product-3.jpg","./image-product-4.jpg"]
let currentImg =0;
function nextImage() {
    if (currentImg == 3) {
      currentImg = 1;
    ...
    mobBigImg.src = imageArr[currentImg];
}
